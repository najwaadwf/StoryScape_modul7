...
class Home : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val recyclerView: RecyclerView = view.findViewById(R.id.bestselling)
        recyclerView.setHasFixedSize(true)
        adapter = HomeAdapter(requireContext(), NovelList) { novel ->
            val intent = Intent(requireContext(), DetailActivity::class.java)
            intent.putExtra(BestSelling.INTENT_PARCELABLE, novel)
